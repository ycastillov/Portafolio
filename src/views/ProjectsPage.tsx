  ...
  const projects = [
    {
      ...
      description: 'Una app web para gestionar tareas personales, con soporte para etiquetas, prioridades y persistencia local.',
    ...
    },
    {
      ...
      description: 'Sitio web para mostrar mis proyectos, habilidades y contacto. Implementado con Next.js y diseño responsive.',
    ...
    },
    {
      ...
      description: 'Una API REST para gestión de productos con filtrado y ordenamiento. Implementada con ASP.NET Core.',
