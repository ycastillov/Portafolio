...
export default function SkillsPage() {
  return (
    <section className="max-w-4xl mx-auto px-4 py-20">
      <h2 className="text-3xl sm:text-4xl font-bold mb-10 text-center">Habilidades</h2>
              ...
              {group.skills.map((skill) => (
                <li key={skill.name}>
                  <Badge variant="secondary">
                    {skill.name} <span className="ml-2 text-xs text-muted-foreground">({skill.level})</span>
                  </Badge>
                </li>
              ))}
            </ul>
